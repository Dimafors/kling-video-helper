...
st.markdown("Загрузите изображение и опишите движение — получите видео через **Kling AI**!")
...
if uploaded_file:
    ...
    st.info("ℹ️ Это приложение помогает подготовить запрос для [Kling AI](https://kling.ai)")
